...
$(document).ready(function(){
	...
	*/
	...
	/*
	Purpose: sent "btnClear"'s click method's contents to its own method.
	Parameters: none.
	Return: none.
	*/
	...
	/*
	Purpose: 2nd method for btnClear to call.  Confirm the screen was cleared by alert (if alerts are enabled by the checkbox).
	Parameters: none.
	Return: none.
	*/
	function promptAboutClearingScreen(){
		alertFiltered("The screen was cleared.");
	}
	...
	*/
	...
	//MOD: uses event handler without JQuery.
	//$("#btnFire").click(function(){
	document.getElementById("btnFire").onclick = function(){
		intEventIndex = 1;
	...
	document.getElementById("btnPlunder").onclick = function(){
		intEventIndex = 2;
	...
	document.getElementById("btnTaunt").onclick = function(){
		intEventIndex = 3;
	...
	//MODDD - uses an action listener without JQuery.
	//$("#btnRepair").click(function(){
	document.getElementById("btnRepair").addEventListener("click",
		//function is declared as the argument at the same time, as it won't need to be referred to again.
		function(){
			intEventIndex = 4;
	...
	document.getElementById("btnSwerve").addEventListener("click",
		function(){
			intEventIndex = 5;
