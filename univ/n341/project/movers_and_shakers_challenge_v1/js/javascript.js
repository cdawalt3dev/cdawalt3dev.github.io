...
$(document).ready(function(){
	...
	*/
	...
	/*
	Purpose: btnHide click method.  Hides the "visibility test div".
	Parameters: none
	Return: none
	*/
	...
	/*
	Purpose: btnShow click method.  Shows the "visibility test div".
	Parameters: none
	Return: none
	*/
	...
	/*
	Purpose: btnToggle click method.  Toggle the "visibility test div" (that is, "show" if hidden, "hide" if visible).
	Parameters: none
	Return: none
	*/
	...
	*/
	...
	/*
	Purpose: btnFadeIn click method.  Fade in the "fade test div".
	Parameters: none
	Return: none
	*/
	...
	/*
	Purpose: btnFadeOut click method.  Fade out the "fade test div".
	Parameters: none
	Return: none
	*/
	...
	/*
	Purpose: btnFadeToggle click method.  Fade out the "fade test div".
	Parameters: none
	Return: none
	*/
	...
	*/
	...
	/*
	Purpose: btnAllVisibility click method.  This chains together all non-toggle animations above (hide / show, fade in / out, slide up / down).
	Parameters: none
	Return: none
	*/
	...
	*/
	...
	/*
	Purpose: btnNudgeLeft click method.  Move the element 20 pixels in a direction by animation.  Controlled so that it may not move out of bounds.
	Parameters: none
	Return: none
	*/
	$("#btnNudgeLeft").click(function(){
		...
		if(fltTargetX >= fltTestNudgeXOrigin - (66)){
	...
	*/
	$("#btnNudgeUp").click(function(){
		...
		//how far am I allowed to go?  Some distance away from the origin.
		if(fltTargetY >= fltTestNudgeYOrigin - (66)){
	...
	*/
	...
	/*
	Purpose: btnEasing click method. Force the easing mode to one hardcoded instead of the one provided by the text box at the bottom of the window.  It is used to apply a "Fade" effect by changing opacity.
	Parameters: none
	Return: none
	*/
