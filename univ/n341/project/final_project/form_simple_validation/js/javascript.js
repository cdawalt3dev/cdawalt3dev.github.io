...
/*
 ...
 PURPOSE: See form_prototype.html
...
$(document).ready(function(){
	...
	*/
	...
	/*
	Purpose: Validation setup.  The "errorPlacement" event is used to ensure any error for the radio group is placed after all radio buttons.
	Parameters: none
	Return: none
	*/
	...
	*/
	...
	/*
	Purpose: do some last-minute validation (notify the user if neither means of contact has been provided), then proceed to scrape the data to print into the output text area at the bottom of the form.
	Parameters: none
	Return: none
	*/
	function submitFormEvent(){
		...
		if( $("#txtContactEmail").val().trim() === "" && $("#txtTelephoneNumber").val().trim() ===""){
			//e.preventDefault();
			alert("No means of contact provided.  Please provide an email address or telephone number.");
			return;
		}
